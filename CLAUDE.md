...
- 002-ide-panels: Added TypeScript 5.7, Node.js 20 LTS + Express 4, React 18, Vite 6, better-sqlite3, xterm.js 5, @monaco-editor/react 4.6, diff2html 3.4, chokidar 4, ws 8, Tailwind CSS 3

- 001-c3-dashboard: Added TypeScript 5.x, Node.js 20 LTS + React 18, Tailwind CSS 3, xterm.js 5, Monaco Editor, Express, node-pty, ssh2, chokidar, diff2html, ws
